...
def find_downloaded_file(workdir):
    ...
    # Eng katta haqiqiy video faylni tanlaymiz
...
def encode_video(
    ...
    # -----------------------------------------------------
    # YANGI FAYL DIMENSION TEKSHIRISH
    # -----------------------------------------------------
